...
# Projection transformation functions (gluPerspective(), glOrtho(), ...)
# should be called with glMatrixMode(GL_PROJECTION).

# Modeling & viewing transformation functions (gluLookAt(), glTranslate(), ...)
# should be called with glMatrixMode(GL_MODELVIEW).
